...
<img src="`r pkgdown_url("example/slides.gif")`" width=500>
...
<img src="`r pkgdown_url("example/title_slide.png")`" width=500>
...
<img src="`r pkgdown_url("example/title_social.png")`" width=500>
