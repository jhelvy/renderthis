...
Build html from Rmd file [view example html slides](https://jhelvy.github.io/xaringanBuilder/example/slides.html):
```
build_html("slides.Rmd")
```

Build pdf from Rmd or html file [view example pdf slides](https://jhelvy.github.io/xaringanBuilder/example/slides.pdf):
```
...
```
Example:
<img src="example/slides.gif" width=660>
...
```
Example:
<img src="example/slides.png" width=660>

Build everything (html, pdf, gif, and thumbnail of first slide) from Rmd file:
```
