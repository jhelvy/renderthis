...
- [Latest Release](https://github.com/jhelvy/xaringanBuilder/releases/latest): 0.0.1

## Citation Information

If you use this package for in a publication, I would greatly appreciate it if you cited it. You can get the citation information by typing `citation("xaringanBuilder")` into R:
