...
### All output types
Build all output types from Rmd file - control outputs with `include` argument:
```
...
### PPTX
Build pptx from Rmd, html or pdf file ([view example pptx slides](https://jhelvy.github.io/xaringanBuilder/inst/example/slides.pptx)):
```
